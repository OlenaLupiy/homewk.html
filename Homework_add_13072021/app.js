...
//     document.write(`<div>${simpson.name}-${simpson.surname}-${simpson.age}-${simpson.info}-${simpson.photo}`)
//
// }
// document.write('</div>');
...
// document.write('<div>')
// for (let simpson of simpsons){
//     document.write(`<h2>${simpson.name}${simpson.surname} age is ${simpson.age}</h2>h2>`);
